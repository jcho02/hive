...
func (m *MockAPI) GetDNSRecordsByName(ctx context.Context, crnstr, zoneID, recordName string, publish types.PublishingStrategy) ([]powervsclient.DNSRecordResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDNSRecordsByName", ctx, crnstr, zoneID, recordName, publish)
	ret0, _ := ret[0].([]powervsclient.DNSRecordResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) GetDNSZones(ctx context.Context, publish types.PublishingStrategy) ([]powervsclient.DNSZoneResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDNSZones", ctx, publish)
	ret0, _ := ret[0].([]powervsclient.DNSZoneResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
